...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondaryText = const Color(0xFF2B313D);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFF5785E0);
  late Color accent2 = const Color(0xFFDBE8FF);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFF1B1F26);
  late Color tertiary = const Color(0xFFE86969);
  late Color alternate = const Color(0xFF262D34);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFFD9E1ED);
